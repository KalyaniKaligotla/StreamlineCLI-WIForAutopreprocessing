...
class Preprocessor:
    ...
    tasks = [
        ...
        # "8. Build K-Nearest Neighbors (KNN) Model",
        '6. Classification Model Building',
    ...
    def removeTargetColumn(self):
        ...
        while True:
            ...
            if choice.lower() == "y":
                try:
                    # Remove the column only if it's not the target variable
                    if target_column != 'salary':
    ...
    def preprocessorMain(self):
        ...
        while(1):
            ...
            # moves the control into the Download class.
                ...
                ModelBuilder.build_classification_model(self.data, target_variable)

            elif choice == 7:
                target_variable = input("Enter the target variable: ")
                ModelBuilder.build_regression_model(self.data, target_variable) 
